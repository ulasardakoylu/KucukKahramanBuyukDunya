...
public partial class Level2_2Sclvl : Area2D
{
    [Export] public string SecretLevelPath = "res://Assets/Scenes/Areas/level_2_2_sclvlMain.tscn";
    [Export] public string SecretLevelID = "level2_2";
    ...
    public override void _Ready()
    {
        ...
        _entrance = GetNodeOrNull<CollisionShape2D>("2_2entrance");
        _exit = GetNodeOrNull<CollisionShape2D>("2_2exit");
